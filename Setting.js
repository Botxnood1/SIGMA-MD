...
global.owner = process.env.OWNER_NUMBER  || '919633119220' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://jimmy:jimmy@cluster0.ujgq4ad.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "919633119220" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"SENPAI",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '13_07_2024_SIGMA_MD_RwwmrbtU_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'SENPAI',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `JIM`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'ᝃ 𝐉𝚰𝚳𝚳𝐘 𝚾𝚺𝚪↲ ㍍',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "ꤸ🌻／𝟗𝟔𝟑𝟑𝟏𝟏𝟗𝟐𝟐𝟎 ❲⭒☔⭒❳" ,          // ADD YOUR STICKER PACKNAME
